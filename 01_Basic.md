...
|----------------------|------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------|
| **Promiscuous Mode**  | Promiscuous mode is the default capturing mode in Wireshark. In this mode, the network interface card (NIC) captures all packets it sees on the network, regardless of whether they are addressed to your machine. | General network monitoring and troubleshooting.  |
